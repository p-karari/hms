...
import { searchStockItemsDirect, StockItem } from '@/lib/stockManagement/stockItemDirect';
import { createStockAdjustment, createStockOperation, createStockReceipt, createStockTransfer, getStockOperationTypes } from '@/lib/stockManagement/stockOperation';
import { StockOperationItem, StockOperationType } from '@/lib/stockManagement/stockOperationTypes';

export default function StockOperationFormContent() {
